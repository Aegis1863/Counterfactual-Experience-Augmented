...
import numpy as np
from utils.highway_utils import train_PPO_agent, compute_advantage, read_ckp, CVAE, cvae_train
...
if __name__ == '__main__':
    ...
    cvae = torch.load('data/model/cvae.pt', map_location=device)  # 需要预训练
